...
const Cart = () => {
    ...
    return (
        <div className='mt-7 flex flex-col w-[95%] lg:w-[70%] m-auto gap-5 lg:flex-row'>
                    ...
                    {cartItems.map((item, index) => (
                        <div key={index} className='flex justify-between gap-8 items-center mb-4 p-4 border-b'>
                            <div className='flex items-center gap-4'>
                                ...
                                <div>
                                    <div className='text-xs lg:text-base font-semibold'>The Lost Symbol The Lost Symbol The Lost Symbol The Lost Symbol </div>
            ...
            <div className='w-full lg:w-1/3 bg-white rounded-xl shadow-lg p-6 h-[fit-content]'>
