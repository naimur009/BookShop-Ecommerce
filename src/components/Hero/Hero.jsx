...
const Hero = () => {
    return (
        <div className='flex flex-col items-center gap-0 w-[100%] lg:bg-[#EFFAFC] lg:flex-row'>
            <div className='w-[60%] h-[600px] md:h-[850px] flex flex-col justify-center items-center gap-16'>
                ...
                <a href="#_" className="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-white border-2 border-green-600 rounded-full bg-green-600 hover:text-black group hover:bg-white">
