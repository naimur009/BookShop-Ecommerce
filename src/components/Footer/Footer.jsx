            ...
            <footer className="bg-white rounded-lg shadow-md mb-16 flex flex-col lg:mb-3 justify-center items-center w-[95%] m-auto lg:w-[98%]">
                <div className="w-full mx-auto p-4 flex flex-col items-center justify-between gap-2 lg:flex-row">
                    ...
                    <ul className="flex flex-wrap items-center mt-3 text-sm font-medium sm:mt-0">
                        <li>
                            <NavLink to="/" className="hover:underline me-4 md:me-6 hover:text-green-600">Home</NavLink>
                        </li>
                        <li>
                            <NavLink to="/books" className="hover:underline me-4 md:me-6 hover:text-green-600">All Books</NavLink>
                        </li>
                        <li>
                            <NavLink to="#" className="hover:underline me-4 md:me-6 hover:text-green-600">Licensing</NavLink>
                        </li>
                        <li>
                            <NavLink to="#" className="hover:underline hover:text-green-600">Contact</NavLink>
                        </li>
                    </ul>
                </div>
